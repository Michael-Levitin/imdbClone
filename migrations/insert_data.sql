...
VALUES ('Braveheart',
       ...
       ('Edge of Tomorrow',
        ...
        now(), 7.9, false, now()),
    ('DragonHeart', 'Dragonheart (stylized as DragonHeart) is a 1996 fantasy adventure film directed by Rob Cohen and written by Charles Edward Pogue, based on a story created by him and Patrick Read Johnson. The film stars Dennis Quaid, David Thewlis, Pete Postlethwaite, Dina Meyer, and Sean Connery as the voice of Draco. It was nominated for the Academy Award for Best Visual Effects and various other awards in 1996 and 1997. The film received mixed reviews, with critics praising the premise, visual effects, and character development but panning the script as confusing and clichéd. It was a box-office success, earning $115 million worldwide. It was dedicated to the memory of Steve Price and Irwin Cohen.', now(), 6.4, false, now());
